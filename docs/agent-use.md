...
![Agent bubble hover state](./images/agent-bubble-home.png)

### Open Chamber

![Agent chamber open](./images/agent-panel-open.png)

### Draft Bridge

![Bridge draft opened in Note.md](./images/agent-draft-editor.png)
...
- on hover, it expands slightly and reveals the `Agent` label
